...
namespace AOP.Core.Advice.Weavers.Processes
{
    internal class AdviceAroundProcess : AdviceWeaveProcessBase<AroundAdviceEffect>
    {
        ...
        public AdviceAroundProcess(BaseModuleWeaver weaver, AspectDefinition aspect, MethodDefinition target, AroundAdviceEffect effect) : base(weaver, target, effect, aspect)
        {
